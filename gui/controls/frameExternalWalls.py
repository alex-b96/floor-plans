...
class FrameExternalWalls(ttk.Frame):
    ...
    def __init__(self, parent):
        ...
        ttk.Label(f1, text='No. iterations').pack(padx=5, pady=5, side=LEFT)
        ...
        ttk.Label(f2, text='Threshold').pack(padx=5, pady=5, side=LEFT)
        ...
        self.button_external_walls.pack(padx=5, pady=5, side=LEFT)
